...
@section('content')
    <div id="content">
        ...
        <div class="card shadow" id="tabel-pelanggan">
            <div class="card-body">
                <h2 class="text-dark" style="font-weight: bold;">Pelanggan</h2>
                <div class="d-flex justify-content-end"><button
                        class="btn btn-primary d-sm-flex justify-content-sm-end align-items-sm-center" type="button"
                        data-bs-toggle="modal" data-bs-target="#tambah-pelanggan"><i
        ...
        <div class="modal fade" role="dialog" tabindex="-1" id="tambah-pelanggan">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer"><button class="btn btn-primary" type="submit" data-bs-dismiss="tambahPelanggan">Tambah</button></div>
                </div>
            </div>
        </div>
    </form>
