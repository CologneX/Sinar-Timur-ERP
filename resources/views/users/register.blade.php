<!DOCTYPE html>
<html style="color: #4e77df;">

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
    <title>Register - Sinar Timur ERP</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="/pelanggan">
                                        ...
                                        <div class="mb-3"><input class="form-control form-control-user" type="text"
                                                ...
                                                placeholder="Masukkan Nama" name="name" required="" minlength="1"
                                                value={{ old('name') }}>
                                            @error('nama')
                                        ...
                                        <div class="mb-3"><input class="form-control form-control-user"
                                                type="password" id="exampleInputEmail-1" aria-describedby="emailHelp"
                                                placeholder="Password" name="password" required="" minlength="1"
                                                value={{ old('password') }}>
                                            @error('password')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
